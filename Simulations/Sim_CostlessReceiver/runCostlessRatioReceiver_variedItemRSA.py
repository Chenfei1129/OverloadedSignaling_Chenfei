...
def main():
        randomSeed = 423
        filename = './simulation_costRaioReceiver_a4_r8_seed423_2-9ItemFullVocab_2000_RSA_report_signla.pkl'
        modNames = ['RSA_S1R0', 'RSA_S1R1' ]
        ...
        for indx in range(nruns):
                nItems = np.random.choice(range(2,10))#2,10
